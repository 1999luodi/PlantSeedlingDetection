...
class SoftTeacher(SemiBaseDetector):
    ...
    def rcnn_cls_loss_by_pseudo_instances(self, x: Tuple[Tensor],
        ...
        if 'loss_cls' in losses:
            ...
            # No sampled RoIs for this unsupervised batch; keep a zero loss
            # term to avoid KeyError and preserve expected loss keys.
            losses['loss_cls'] = bbox_results['cls_score'].sum() * 0
        return losses
